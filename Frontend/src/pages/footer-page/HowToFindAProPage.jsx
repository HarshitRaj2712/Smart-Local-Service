  ...
  return (
    <section className="min-h-screen bg-(--bg-main) px-6 py-20 transition-colors duration-200">
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        >
          <h1 className="text-3xl font-bold text-(--text-main)">How to Find and Book a Pro</h1>
        ...
        <div className="rounded-3xl bg-(--bg-surface) p-8 shadow-sm border border-(--border-color)">
          <h2 className="text-xl font-bold text-(--text-main) mb-6">Step-by-step process</h2>
          <div className="space-y-4">
            {steps.map((step, index) => (
              <MotionDiv
                ...
                className="flex gap-4 rounded-2xl border border-(--border-color) p-4"
              >
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs md:text-sm text-(--text-muted) leading-relaxed">{step.text}</p>
                </div>
              </MotionDiv>
            ))}
          </div>
        ...
        <div className="rounded-3xl bg-(--bg-surface) p-8 shadow-sm border border-(--border-color)">
          <h2 className="text-xl font-bold text-(--text-main) mb-4">Pro tips before confirming</h2>
